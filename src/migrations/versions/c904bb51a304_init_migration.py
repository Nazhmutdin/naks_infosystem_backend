...
def upgrade() -> None:
    ...
    op.create_index(
        "gtd_idx", "personal_certification_table", ["gtd"], unique=False
    )
    op.create_index(
        "method_idx", "personal_certification_table", ["method"], unique=False
    )
    op.create_index(
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        "rod_diameter_from_idx", table_name="personal_certification_table"
    )
    op.drop_index(
    ...
    op.drop_index(
        "outer_diameter_from_idx", table_name="personal_certification_table"
    )
    op.drop_index(
        "outer_diameter_before_idx", table_name="personal_certification_table"
    )
    op.drop_index("method_idx", table_name="personal_certification_table")
    op.drop_index("gtd_idx", table_name="personal_certification_table")
    op.drop_index(
        "details_thikness_from_idx", table_name="personal_certification_table"
    )
    op.drop_index(
        "details_thikness_before_idx",
        table_name="personal_certification_table",
