...
class NDTModel(Base):
    ...
    total_accepted: Mapped[float | None] = sa.Column(sa.Float(), nullable=False, default=0)
    total_rejected: Mapped[float | None] = sa.Column(sa.Float(), nullable=False, default=0)
