...
from app.presentation.routes.exc_handler import (
    ...
    personal_nak_certification_not_found_exception_handler,
...
app.add_exception_handler(PersonalNaksCertificationNotFoundException, personal_nak_certification_not_found_exception_handler)
