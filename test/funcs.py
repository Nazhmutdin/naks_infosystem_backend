...
def get_personals() -> list[PersonalShema]:
    ...
    return [PersonalShema.model_validate(personal) for personal in personals]
...
def get_personal_certifications() -> list[PersonalCertificationShema]:
    ...
    return [PersonalCertificationShema.model_validate(certification) for certification in certifications]
